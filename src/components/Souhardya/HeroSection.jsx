  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center">
        {/* Title with Gradient */}
        <h1 className="souhardya-title">SOUHARDYA</h1>
        ...
        {/* Subtitle */}
        <p className="text-xl md:text-2xl text-orange-200 tracking-widest font-bold -mt-4 mb-8" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
