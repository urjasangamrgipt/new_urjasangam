...
export function EventsSection() {
  ...
  const eventsData = {
    coding: [
      { title: "WebXplore", icon: "💻", date: "12-13 October 2025", time: "3 hours", venue: "Lecture Room", description: "A 3-hour web development challenge where teams build a full-stack website from scratch using any tech stack.", participants: "Teams", link: 'https://unstop.com/hackathons/webxplore-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-technology-rgipt-jais--1573289' },
      { title: "Code Climb", icon: "🧗", date: "12-13 October 2025", time: "3 hours", venue: "Lecture Room", description: "A 3-hour online coding hackathon where participants solve algorithmic problems on platforms like Codeforces or HackerEarth.", participants: "Individual", link: 'https://unstop.com/hackathons/codeclimb-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-technology-rgipt-jais--1573292' },
      { title: "RCPC", icon: "🏆", date: "12-13 October 2025", time: "3 hours", venue: "Lecture Room", description: "A team-based ICPC-style coding contest held offline at RGIPT, featuring 8 problems in 3 hours and a live leaderboard.", participants: "Teams", link: 'https://unstop.com/hackathons/rcpc-rgipt-collegiate-programming-contest-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of--1573313' },
      { title: "UI Express", icon: "🎨", date: "12-13 October 2025", time: "3 hours", venue: "Lecture Room", description: "A design challenge where teams create UI/UX solutions based on a surprise theme using tools like Figma or Canva.", participants: "Teams", link: 'https://unstop.com/hackathons/ui-xpress-design-that-speaks-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-tec-1573291' },
      { title: "Code Decipher", icon: "🔍", date: "12-13 October 2025", time: "Two rounds", venue: "Lecture Room", description: "A two-round debugging competition where participants fix errors in given code after an aptitude test.", participants: "Individual", link: 'https://unstop.com/hackathons/code-decipher-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-technology-rgipt-j-1572902' }
    ],
    robotic: [
      { title: "Maze Spark", icon: "🤖", date: "12-13 October 2025", venue: "Lecture Room", description: "Design and program an autonomous robot that can solve a walled maze from start to finish in the shortest time.", participants: "Teams", link: unstopLink },
      { title: "Robosoccer", icon: "⚽", date: "12-13 October 2025", venue: "Lecture Room", description: "Participants design and build manually or autonomously controlled robots that play football against opponents.", participants: "Teams", link: unstopLink },
      { title: "Robo Rescue", icon: "🦾", date: "12-13 October 2025", venue: "Lecture Room", description: "Design and build a pick-and-place robot capable of navigating a rescue arena and transporting objects to a safe zone.", participants: "Teams", link: unstopLink },
      { title: "RC Plane", icon: "✈️", date: "12-13 October 2025", venue: "Lecture Room", description: "Design, build, and pilot a radio-controlled aircraft to demonstrate flight stability, control, and aerodynamic efficiency.", participants: "Teams", link: unstopLink },
      { title: "RC Boat", icon: "🚤", date: "12-13 October 2025", venue: "Lecture Room", description: "Participants design, build, and operate remote-controlled boats to test speed, control, and stability over a water track.", participants: "Teams", link: 'https://unstop.com/competitions/rc-boat-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-technology-rgipt-jais--1572898' },
    ],
    entrepreneurial: [
      { title: "Sell Me If You Can", icon: "🎤", date: "12-13 October 2025", description: "Pitch everyday or weird products in the most creative and convincing way possible.", participants: "Individual/Teams", link: 'https://unstop.com/hackathons/sell-me-if-you-can-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-technology-rg-1573134' },
      { title: "Trader's Arena", icon: "📈", date: "12-13 October 2025", description: "A virtual stock market game where participants buy, sell, and trade shares to build the biggest portfolio.", participants: "Individual/Teams", link: unstopLink },
      { title: "Capital Quest", icon: "💡", date: "12-13 October 2025", description: "An ideathon and pitching challenge where participants brainstorm and present innovative business solutions.", participants: "Teams", link: unstopLink },
      { title: "Startup Fair", icon: "🚀", date: "12-13 October 2025", description: "A startup expo where innovators pitch ideas, showcase ventures, and network with industry leaders.", participants: "Startups", link: unstopLink },
      { title: "MUN (UNHRC)", icon: "🌐", date: "12-13 October 2025", description: "Simulate global debates on pressing international issues in a Model United Nations conference.", participants: "Delegates", link: unstopLink },
    ],
    creative: [
      { event_name: "Water Rocket", icon: '🚀', date: "12–13 October 2025", description: "Design and construct a water rocket that can achieve the maximum air time and distance.", participants: "Teams", link: 'https://unstop.com/competitions/water-rocket-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-technology-rgipt--1572896' },
      { event_name: "CAD Challenge", icon: '🧊', date: "12–13 October 2025", description: "Design a 3D model based on a given problem statement using any CAD software.", participants: "Individual/Teams", link: unstopLink },
      { event_name: "Bridge Making", icon: '🌉', date: "12–13 October 2025", description: "Design and build a strong, stable, and creative truss bridge using provided materials.", participants: "Teams", link: unstopLink },
      { event_name: "KINεTIC KRASH", icon: '💥', date: "12–13 October 2025", description: "Construct an innovative bot powered purely by physics or chemistry that moves autonomously without any electrical power.", participants: "Teams", link: 'https://unstop.com/competitions/kinetic-krash-urjasangam-2k25-the-annual-fest-of-rgipt-rajiv-gandhi-institute-of-petroleum-technology-rgipt-1573013' },
    ]
  };
