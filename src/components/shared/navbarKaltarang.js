...
export default function NavbarKaltarang() {
  ...
  const scrollToSection = (id) => {
    ...
    } else if (pathname !== "/kaltarang") {
      window.location.href = `/kaltarang${id}`;
    }
  };
        ...
        <div className="max-w-[95%] mx-auto flex justify-between items-center px-4 md:px-8">
          ...
          >
            <Image
              ...
              height={45}
            />
            <span className="font-semibold text-lg md:text-xl text-white group-hover:text-[#ff66cc] transition-all">
              Kaltarang
            </span>
          </button>
            ...
            {navLinks.map((link) => (
              <motion.li key={link.href} whileHover={{ scale: 1.05 }}>
                <button
                  ...
                  className="px-5 py-2 font-medium text-sm uppercase text-gray-400 hover:text-[#ff66cc] transition-all duration-300"
                >
                  {link.label}
                </button>
              </motion.li>
                  ...
                  {navLinks.map((link, i) => (
                    ...
                    >
                      <button
                        ...
                        className="block text-left w-full px-6 py-4 rounded-lg font-medium text-base uppercase tracking-wider text-gray-300 hover:text-[#ff66cc] hover:bg-white/5 transition-all"
                      >
                        {link.label}
                      </button>
                    </motion.li>
