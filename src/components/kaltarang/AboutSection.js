            ...
            >
              ...
              >
                ...
                <p className="relative text-lg leading-relaxed bg-black/40 backdrop-blur-sm p-6 rounded-lg border border-white/10">
                 Kaltarang is <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500 font-bold">RGIPT’s annual cultural fest —</span> a vibrant celebration of art, culture, and talent. Over the years, it has become a prestigious platform where creativity meets competition, uniting students from across the country.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="relative text-lg leading-relaxed bg-black/40 backdrop-blur-sm p-6 rounded-lg border border-white/10">
                  Every year, thousands gather to witness mesmerizing performances, thrilling competitions, and unforgettable moments of cultural brilliance.
                </p>
              </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-xl p-8 rounded-2xl border border-orange-500/30 group-hover:border-orange-500/60 transition-all duration-300">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                   To inspire creativity and cultural expression by building a space where imagination, tradition, and innovation come together, making Kaltarang a symbol of youthful energy and artistic excellence.
                  </p>
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-xl p-8 rounded-2xl border border-purple-500/30 group-hover:border-purple-500/60 transition-all duration-300">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    To provide a platform for students to showcase their talents, celebrate diversity, and promote collaboration through art and culture
                  </p>
