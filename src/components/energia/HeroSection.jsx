    ...
    >
      <style>{`
        ...
        .energia-title {
          ...
          font-weight: 900;
          background: linear-gradient(135deg, #c084fc 0%, #a78bfa 25%, #8b5cf6 50%, #a855f7 75%, #c084fc 100%);
      ...
      <div className="relative z-20 flex flex-col items-center">
        ...
        {/* Subtitle */}
        <p className="text-xl md:text-2xl text-violet-200 tracking-widest font-bold -mt-4 mb-8" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
