...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="h-screen w-full flex flex-col justify-center items-center text-center overflow-hidden relative font-sans"
    >
      {/* Video Background */}
      <video
        id="hero-video"
      ...
      <div className="relative z-20">
        ...
        <motion.p
          ...
          className="text-xl md:text-2xl mt-4 text-violet-200 tracking-wider font-semibold"
        >
